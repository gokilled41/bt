...
public class DefaultMapOptions implements MapOptions {
    ...
    public DefaultMapOptions(Map<String, Object> context) {
        ...
        conversionMethod = (ConversionMethod) processEnumerativeOption(context, MapOptions.CONVERTION_METHOD,
                ConversionMethod.document, infoBuilder);
        ...
        keepProcessingInstructions = processBooleanOption(context, MapOptions.KEEP_PROCESSING_INSTRUCTION, false,
                infoBuilder);
        processingInstructionPrefix = processStringOption(context, MapOptions.PROCESSING_INSTRUCTION_PREFIX, "pi#",
                infoBuilder);
        ...
        attributeRetainNS = (RetainNamespacePrefix) processEnumerativeOption(context,
                MapOptions.ATTRIBUTE_RETAIN_NAMESPACE_PREFIX, RetainNamespacePrefix.dependent, infoBuilder);
        ...
        elementRetainNS = (RetainNamespacePrefix) processEnumerativeOption(context,
                MapOptions.ELEMENT_RETAIN_NAMESPACE_PREFIX, RetainNamespacePrefix.dependent, infoBuilder);

        info = infoBuilder.toString();
    }

    private String processStringOption(Map<String, Object> options, String key, String defaultValue,
    ...
    private boolean processBooleanOption(Map<String, Object> options, String key, boolean defaultValue,
            StringBuilder builder) {
    ...
    private Enum processEnumerativeOption(Map<String, Object> options, String key, Enum defaultValue,
            StringBuilder builder) {
        String value = (String) options.get(key);
        Enum result;
