...
public class TestEventInjectorForJBoss7 {

    private static final String providerUrl = "remote://localhost:4447";
    ...
    public static void main(String[] args) throws Exception {
        ...
        // environment.put("java.naming.factory.initial", "org.jboss.naming.remote.client.InitialContextFactory");

        environment.put(Context.INITIAL_CONTEXT_FACTORY, "org.jboss.naming.remote.client.InitialContextFactory");
        environment.put(Context.PROVIDER_URL, providerUrl);
        environment.put(Context.SECURITY_PRINCIPAL, "vtbaadmin");
        environment.put(Context.SECURITY_CREDENTIALS, "vitria");
        ...
        TestEventInjectorForJBoss7 client = new TestEventInjectorForJBoss7();
    ...
    public final static String QUEUE_CONNECTION_FACTORY = "jms/RemoteConnectionFactory";
