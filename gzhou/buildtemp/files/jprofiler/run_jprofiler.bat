...
rem $Id: run.bat 74132 2008-06-05 10:38:10Z galder.zamarreno@jboss.com $
...
set PATH=C:\Program Files\jprofiler5\bin\windows;%PATH%
set JAVA_OPTS="-agentlib:jprofilerti=port=8849,nowait,id=107,config=C:\Documents and Settings\gzhou\.jprofiler5\config.xml"  "-Xbootclasspath/a:C:\Program Files\jprofiler5\bin\agent.jar" %JAVA_OPTS%
...
set JAVA_OPTS=%JAVA_OPTS% -Xms128m -Xmx512m -XX:PermSize=64M -XX:MaxPermSize=512M -XX:+UseSerialGC
