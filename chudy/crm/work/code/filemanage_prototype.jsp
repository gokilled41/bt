...
<body>
    ...
    <div class="ch-container">
            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div class="box-content">
                    <div style="float:right;margin-right:30px">
                        <a id="add-file-activity-btn"  class="btn btn-success"><i class="glyphicon glyphicon-zoom-in icon-white"></i> 创建文件业务</a>
                    </div>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane active" >
                            <div>&nbsp;</div>
                            <div id="search-panel">
                                <div id="search-file-activity-form">
                                    <!--
                                    <div class="form-group col-md-2 searchbox">
                                        <label for="name" class="control-label">&nbsp;我的审批进度</label>
                                        <select id="search-name" name="name" title="选择业务状态" class="form-control">
                                    ...
                                    <div class="form-group col-md-2 searchbox">
                                        ...
                                        <input type="text" id="search-name" name="name" placeholder="搜索文件业务" class="form-control">
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label for="key" class="control-label">&nbsp;</label>
                                        <a id="list-file-activity-btn" class="btn btn-primary form-control"> 查找 </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <hr>
                            <div>
                                <table id="file-activity-table" class="table table-striped" cellspacing="0" width="100%">
                                    <thead>
                                       <tr>
                                          <th>申请号</th>
                                          <th>部门</th>
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td>BD000001</td>
                                          <td>
                                             <a class="btn btn-primary btn-sm" href="javascript:updateFileActivity(1, 'AS2016000001')"> 编辑 </a>
                                             <a class="btn btn-danger btn-sm"  href="javascript:deleteFileActivity(1, 'AS2016000001')"> 删除 </a>
                                          </td>
                                       </tr>
                                       <tr>
                                          <td>AS2016000001</td>
        ...
        <!-- modal starts -->
        <div class="modal fade" id="add-file-activity-modal" tabindex="-1"
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="add-file-activity-form" action="<%=path%>/admin/addFileActivity" method="post">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="add-file-activity-go-review-btn" class="btn btn-primary"> 预 览 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="add-file-activity-review-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <label id="add-file-activity-note" class="cr hd"></label>
                        <a id="add-file-activity-return-edit-btn" class="btn btn-primary"> 返回编辑 </a>
                        <a id="add-file-activity-auth-btn" class="btn btn-primary"> 设定权限 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="add-file-activity-do-auth-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <label id="add-file-activity-note" class="cr hd"></label>
                        <a id="add-file-activity-review-auth-btn" class="btn btn-primary"> 预 览 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="add-file-activity-do-review-auth-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="add-file-activity-submit-btn" class="btn btn-primary"> 提交 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="update-file-activity-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="update-file-activity-form" action="<%=path%>/admin/updateFileActivity" method="post">
                            <div class="form-group col-md-3">
                                <label>申请号</label>
                    ...
                    <div class="modal-footer">
                        <label id="update-file-activity-note" class="cr hd"></label>
                        <a id="update-file-activity-go-review-btn" class="btn btn-primary" data-dismiss="modal"> 确 认 </a>
        ...
        <div class="modal fade" id="list-file-award-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div style="float:right;margin-right:30px">
                            <a id="add-file-award-btn"  class="btn btn-success"><i class="glyphicon glyphicon-plus icon-white"></i> 添加奖项</a>
                        </div>
                        <div style="clear: both;"></div>
                        <hr style="margin-top:2px;margin-bottom:2px;">
                        <div>
                            <table id="file-award-table" class="display" cellspacing="0" width="100%"></table>
        ...
        <div class="modal fade" id="add-file-award-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:600px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- form -->
                        <form id="add-file-award-form" action="<%=path%>/admin/addFileAward" method="post">
                    ...
                    <div class="modal-footer">
                        <a id="add-file-award-do-btn" class="btn btn-primary" data-dismiss="modal"> 确 定 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 取 消 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="update-file-award-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:600px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- form -->
                        <form id="update-file-award-form" action="<%=path%>/admin/updateFileAward" method="post">
                            <div class="form-group hide">
                    ...
                    <div class="modal-footer">
                        <a id="update-file-award-do-btn" class="btn btn-primary" data-dismiss="modal"> 确 定 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 取 消 </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="list-file-record-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:1200px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <table id="file-record-table" class="display" cellspacing="0" width="100%"></table>
