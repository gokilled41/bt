...
<head>
    ...
    <script src="<%=path%>/admin/adminjs/reviewmanage2.js"></script>
...
<body>
    ...
    <div class="ch-container">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="review-approval-show-review-detail-1-btn" class="btn btn-primary"> 查看一级审批结果 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="review-approval-review-detail-1-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <table class="table table-striped">
                            <tbody>
                                ...
                                <tr>
                                    <td>审批意见</td>
                                    <td>审批意见：<br>1. 第一条审批意见<br>2. 第二条审批意见</td>
                                </tr>
                                <tr>
                                    <td>审批结论</td>
                                    <td>通过</td>
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="review-approval-submit-btn" class="btn btn-primary"> 提交三级审批人审批 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="review-approval-confirm-reviewer-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <label id="add-approval-note" class="cr hd"></label>
                        <a id="review-approval-confirm-reviewer-reselect-btn" class="btn btn-primary"> 重新选择二级评审人员 </a>
                        <a id="review-approval-confirm-reviewer-submit-btn" class="btn btn-primary"> 提 交 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="review-approval-reselect-reviewer-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <label id="add-approval-note" class="cr hd"></label>
                        <a id="review-approval-resubmit-btn" class="btn btn-primary"> 提 交 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="add-approval-select-reviewer-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table class="table">
                            <tbody>
                                ...
                                <tr style="background-color:lightgrey;" class="tl3">
                                    <td colspan="2">三级审批人</td>
                                </tr>
                                <tr class="hr3">
                                    <td colspan="2">
                                        <input type="checkbox">审批人1
                                        <input type="checkbox" checked="true">审批人2
                                        <input type="checkbox">审批人3
                                        <input type="checkbox">审批人4
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    <div class="modal-footer">
                        <label id="add-approval-note" class="cr hd"></label>
                        <a id="add-approval-select-reviewer-return-edit-btn" class="btn btn-primary"> 返回编辑 </a>
                        <a id="add-approval-submit-btn" class="btn btn-primary"> 发起评审 </a>
                        <a href="#" class="btn btn-default" data-dismiss="modal"> 退 出 </a>
                    </div>
                </div>
            </div>
