...
<head>
    ...
    <link href='<%=path%>/admin/css/crm.css' rel='stylesheet'>
    ...
    <script src="<%=path%>/admin/adminjs/authmanage.js"></script>
...
<body>
    ...
    <div class="ch-container">
            ...
            <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<%=path%>/page/admin/authmanage.shtml">文件查询权限管理</a></li>
                    </ul>
                </div>
                <!-- breadcrumb end -->
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="view-approval-detail-auth-btn" class="btn btn-primary"> 设定权限 </a>
        ...
        <div class="modal fade" id="view-approval-auth-modal" tabindex="-1"
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table id="view-auth-table" class="table">
                        </table>
                    </div>
                    <div class="modal-footer">
                        <label id="view-approval-auth-note" class="cr hd"></label>
                        <a id="view-approval-auth-review-btn" class="btn btn-primary"> 预 览 </a>
        ...
        <div class="modal fade" id="view-approval-reviewauth-modal" tabindex="-1"
            role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog" style="width:800px">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <table id="view-reviewauth-table" class="table table-striped">
                        </table>
                        <form id="update-auth-form" action="<%=path%>/auth/updateUsers.shtml" method="post" class="hd">
                            ...
                            <div class="form-group hd">
                                <label>权限</label>
                                <input type="text" placeholder="权限" id="update-users" name="users" class="form-control">
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <label id="view-approval-reviewauth-note" class="cr hd"></label>
                        <a id="view-approval-reviewauth-submit-btn" class="btn btn-primary"> 提 交 </a>
                        <a id="view-approval-reviewauth-return-btn" class="btn btn-default"> 返 回 </a>
                        <a id="view-approval-reviewauth-cancel-btn" class="btn btn-default" data-dismiss="modal"> 取 消 </a>
                    </div>
                </div>
            </div>
        </div>
